  ...
  return (
    <div className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8 space-y-16 pb-20">
      <div className="text-center mb-16 pt-12 animate-fade-in">
        <h1 className="text-5xl sm:text-6xl md:text-7xl font-semibold text-gray-900 mb-6 tracking-tight">
          Free Coloring Pages
        </h1>
        <p className="text-xl sm:text-2xl text-gray-600 max-w-2xl mx-auto mb-10 font-medium font-rounded">
